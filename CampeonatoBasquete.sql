...
-- PREMISSA DA 3 EM DIANTE: JOGOS < NOW()
-- 3) Mostrar os jogadores que pontuaram em todos os jogos de seus times.
select * from tabela_completa where (cestas2 > 0) or (cestas3 > 0) or (lanceslivres > 0);
-- 4) Mostrar os jogadores que marcaram cestas de 3 pontos em 3 jogos consecutivos de seus times.
...
-- selects dos jogos de cada time

select * from jogo where time1 = 3 or time2 = 3;
select * from jogo where time1 = 4 or time2 = 4;
select * from jogo where time1 = 5 or time2 = 5;
select * from jogo where time1 = 6 or time2 = 6;
select * from jogo where time1 = 7 or time2 = 7;
select * from jogo where time1 = 8 or time2 = 8;
select * from jogo where time1 = 9 or time2 = 9;
select * from jogo where time1 = 10 or time2 = 10;
/*
